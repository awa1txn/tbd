...
export default function Page() {
  ...
  return (<>
    ...
    <p style={{ width: '240px' }}>
      Проект знаходиться у тестовому режимі, тому нажаль ви не можете приєднатись до існуючих ігор самі. Аби подивитись існуючі ігри, запитайте в когось ключову фразу та приєднайтесь через меню приватниих ігор.
    </p>
